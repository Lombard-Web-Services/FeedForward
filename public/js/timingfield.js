(function( $ ) {
    ...
    $.fn.timingfield.template = '<div class="timingfield">\
        <div class="timingfield_hours">\
            <button type="button" class="timingfield_next" tabindex="-1" style="background-color:#006dbf;border-color:#13578B;border-radius:0.25rem 0.25rem 0 0;width:100%"><span style="background:#006dbf;color:#ffffff;">+</span></button>\
            <div class="input-group">\
                <input type="text" class="form-control">\
                <span class="input-group-addon"></span>\
            </div>\
            <button type="button" class="timingfield_prev" tabindex="-1" style="background-color:#006dbf;border-color:#13578B;border-radius:0 0 0.25rem 0.25rem;width:100%"><span style="background:#006dbf;color:#ffffff;">-</span></button>\
        </div>\
